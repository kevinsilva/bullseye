...
export default function FilterTicker() {
  ...
  return (
    <Autocomplete options={securityNames} renderInput={(params) => <TextField {...params} label="Select Security" variant="outlined" />} onChange={handleSelectChange} sx={{ width: "100%", maxWidth: "300px" }} id="filter-ticker" />
  )
}
